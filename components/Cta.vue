        ...
        <div class="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
            <div
                ...
                <div class="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
                    <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">{{ layout.headline }}</h2>
                    <p class="mt-6 text-lg leading-8 text-gray-300">{{ layout.link_1.link.text }}</p>
                    <div class="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
                        ...
                        <a href="#" class="text-sm font-semibold leading-6 text-white">{{ layout.link_2.link.text }} <span
